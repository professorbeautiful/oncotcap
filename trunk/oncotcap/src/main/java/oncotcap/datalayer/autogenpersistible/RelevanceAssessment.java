...
public class RelevanceAssessment extends AutoGenPersistibleWithKeywords 
 {
...
public RelevanceAssessment(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return RelevanceAssessmentPanel.class;
	}
