...
public class CellKineticsDemoController extends ModelController
 {
...
public CellKineticsDemoController() {
init();
}


public CellKineticsDemoController(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return CellKineticsDemoControllerPanel.class;
	}
	public String getPrettyName()
	{
		return "CellKineticsDemoController";
	}
