...
public class PatientEncounterController extends ModelController
 {
...
public PatientEncounterController(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return PatientEncounterControllerPanel.class;
	}
