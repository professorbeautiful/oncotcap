...
public class ConfidenceAssessment extends AutoGenPersistibleWithKeywords 
 {
...
public ConfidenceAssessment(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return ConfidenceAssessmentPanel.class;
	}
