...
public class ValidationSuiteController extends ModelController
 {
...
public ValidationSuiteController() {
init();
}


public ValidationSuiteController(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return ValidationSuiteControllerPanel.class;
	}
	public String getPrettyName()
	{
		return "ValidationSuiteController";
	}
