...
public class ModelSelectionController extends ModelController
 {
...
public ModelSelectionController(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return ModelSelectionControllerPanel.class;
	}
