...
public class BioPhysSubmodel extends SubModel
 {
...
public BioPhysSubmodel() {
init();
}


public BioPhysSubmodel(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return BioPhysSubmodelPanel.class;
	}
	public String getPrettyName()
	{
		return "BioPhysSubmodel";
	}
