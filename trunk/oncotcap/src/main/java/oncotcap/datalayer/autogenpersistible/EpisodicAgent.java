...
public class EpisodicAgent extends AutoGenPersistibleWithKeywords 
 {
...
public EpisodicAgent() {
init();
}


public EpisodicAgent(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return EpisodicAgentPanel.class;
	}
