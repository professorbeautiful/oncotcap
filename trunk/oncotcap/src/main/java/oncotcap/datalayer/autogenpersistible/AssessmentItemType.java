...
public class AssessmentItemType extends AutoGenPersistibleWithKeywords 
 {
...
public AssessmentItemType(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return AssessmentItemTypePanel.class;
	}
