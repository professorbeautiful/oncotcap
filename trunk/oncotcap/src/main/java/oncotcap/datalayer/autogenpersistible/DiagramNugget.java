...
public class DiagramNugget extends KnowledgeNugget
 {
...
public DiagramNugget() {
init();
}


public DiagramNugget(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return DiagramNuggetPanel.class;
	}
	public String getPrettyName()
	{
		return "DiagramNugget";
	}
