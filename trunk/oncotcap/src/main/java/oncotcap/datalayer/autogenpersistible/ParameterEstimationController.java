...
public class ParameterEstimationController extends ModelController
 {
...
public ParameterEstimationController() {
init();
}


public ParameterEstimationController(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return ParameterEstimationControllerPanel.class;
	}
	public String getPrettyName()
	{
		return "ParameterEstimationController";
	}
