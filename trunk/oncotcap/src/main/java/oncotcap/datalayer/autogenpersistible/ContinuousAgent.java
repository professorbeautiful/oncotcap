...
public class ContinuousAgent extends AutoGenPersistibleWithKeywords 
 {
...
public ContinuousAgent() {
init();
}


public ContinuousAgent(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return ContinuousAgentPanel.class;
	}
