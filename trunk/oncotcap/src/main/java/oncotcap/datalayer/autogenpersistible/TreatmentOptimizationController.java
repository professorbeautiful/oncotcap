...
public class TreatmentOptimizationController extends ModelController
 {
...
public TreatmentOptimizationController() {
init();
}


public TreatmentOptimizationController(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return TreatmentOptimizationControllerPanel.class;
	}
	public String getPrettyName()
	{
		return "TreatmentOptimizationController";
	}
