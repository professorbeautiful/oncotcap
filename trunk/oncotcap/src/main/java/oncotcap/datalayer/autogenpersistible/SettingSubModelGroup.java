...
public class SettingSubModelGroup extends SubModelGroup
 {
...
public SettingSubModelGroup() {
init();
}


public SettingSubModelGroup(oncotcap.util.GUID guid) {
	super(guid);
	init();
}
private void init() {
	...
	{
		return SettingSubModelGroupPanel.class;
	}
	public String getPrettyName()
	{
		return "SettingSubModelGroup";
	}
