// $ANTLR 2.7.3: "java.g" -> "JavaRecognizer.java"$
  ...
  astFactory = new ASTFactory(getTokenTypeToASTClassMap());
	...
	public final void classDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			classDefinition_AST = (AST)astFactory.make( (new ASTArray(6)).add(astFactory.create(CLASS_DEF,"CLASS_DEF")).add(modifiers).add(tmp52_AST).add(sc_AST).add(ic_AST).add(cb_AST));
	...
	public final void interfaceDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			interfaceDefinition_AST = (AST)astFactory.make( (new ASTArray(5)).add(astFactory.create(INTERFACE_DEF,"INTERFACE_DEF")).add(modifiers).add(tmp54_AST).add(ie_AST).add(cb_AST));
	...
	public final void field() throws RecognitionException, TokenStreamException {
		...
		if ((_tokenSet_11.member(LA(1))) && (_tokenSet_12.member(LA(2)))) {
			...
			default:
				if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
				...
				else if (((LA(1) >= LITERAL_void && LA(1) <= IDENT)) && (_tokenSet_13.member(LA(2)))) {
					typeSpec(false);
					t_AST = (AST)returnAST;
					{
					if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
						...
						if ( inputState.guessing==0 ) {
							field_AST = (AST)currentAST.root;
							field_AST = (AST)astFactory.make( (new ASTArray(7)).add(astFactory.create(METHOD_DEF,"METHOD_DEF")).add(mods_AST).add((AST)astFactory.make( (new ASTArray(2)).add(astFactory.create(TYPE,"TYPE")).add(rt_AST))).add(tmp85_AST).add(param_AST).add(tc_AST).add(s2_AST));
							currentAST.root = field_AST;
							currentAST.child = field_AST!=null &&field_AST.getFirstChild()!=null ?
								field_AST.getFirstChild() : field_AST;
							currentAST.advanceChildToEnd();
					...
					else if ((LA(1)==IDENT) && (_tokenSet_14.member(LA(2)))) {
 ...
 */
	...
	public final void forInit() throws RecognitionException, TokenStreamException {
		...
		else if ((_tokenSet_5.member(LA(1))) && (_tokenSet_18.member(LA(2)))) {
			expressionList();
			astFactory.addASTChild(currentAST, returnAST);
		}
		else if ((LA(1)==SEMI)) {
 ...
 */
	...
	private static final long[] mk_tokenSet_1() {
		long[] data = { -1729906174200905726L, -4611686009838393729L, 65532L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_1 = new BitSet(mk_tokenSet_1());
	private static final long[] mk_tokenSet_2() {
		long[] data = { -383179802279934L, -284801L, 65535L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_24() {
		long[] data = { -101704825569278L, -25770070145L, 65535L, 0L, 0L, 0L};
		return data;
	}
