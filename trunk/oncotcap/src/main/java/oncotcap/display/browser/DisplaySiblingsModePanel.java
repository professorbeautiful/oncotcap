...
public class DisplaySiblingsModePanel extends JPanel 
		...
		public DisplaySiblingsModePanel() {
				init();
		}
		...
		private void init() {
				...
				JLabel label = new JLabel("Show Siblings: " );
			// 	label.setForeground(new Color(102,101,81));
