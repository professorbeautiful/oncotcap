...
public final class SplashScreen extends Frame {
	...
	private void initImageAndTracker(){
		...
		if ( fImage == null ){
			fImage = OncoTcapIcons.getSplashScreenImage().getImage();
		}
	...
	private class SplashWindow extends Window {
		...
		public void paint(Graphics graphics) {
			if (fImage != null) {
				...
				String version = 
					"Version " + Oncotcap.getMajorVersion() + "." + Oncotcap.getMinorVersion() + "." + Oncotcap.getBuild();
				graphics.drawString(version, fImage.getWidth(this)-155, fImage.getHeight(this) - 60);
				SimpleDateFormat format = new SimpleDateFormat("MM/dd/yyyy");
				String buildDate = "Built: " + format.format(Oncotcap.getBuildDate());
				graphics.drawString(buildDate, fImage.getWidth(this)-155, fImage.getHeight(this) - 45);
			}
		}
	...
	private static void main(String[] args){
		SplashScreen splashScreen = new SplashScreen("../resource/image/erth16x16.gif");
		splashScreen.splash();
		try {
			Thread.sleep(2000);
		}
