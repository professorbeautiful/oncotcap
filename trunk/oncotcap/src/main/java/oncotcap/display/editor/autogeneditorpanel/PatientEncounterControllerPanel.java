...
public class PatientEncounterControllerPanel extends DefaultEditorPanel
{
	...
	public  PatientEncounterControllerPanel() {
		super();
		editObj = new PatientEncounterController();
		initUI();
		fillUiHashtable();
	}


	public  PatientEncounterControllerPanel(PatientEncounterController editObj) {
		super();
	...
	this.editObj = (PatientEncounterController)editObj;
	initUI();
	}
	private void initUI() {
...
submodelGroups.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		PatientEncounterControllerPanel p = new PatientEncounterControllerPanel();
