...
public class ModifyPositiveIntegerPanel extends DefaultEditorPanel
{
	...
	public  ModifyPositiveIntegerPanel() {
		super();
		editObj = new ModifyPositiveInteger();
		initUI();
		fillUiHashtable();
	}


	public  ModifyPositiveIntegerPanel(ModifyPositiveInteger editObj) {
		super();
	...
	this.editObj = (ModifyPositiveInteger)editObj;
	initUI();
	}
	private void initUI() {
...
creator.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ModifyPositiveIntegerPanel p = new ModifyPositiveIntegerPanel();
