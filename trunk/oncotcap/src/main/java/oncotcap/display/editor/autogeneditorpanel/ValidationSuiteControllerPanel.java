...
public class ValidationSuiteControllerPanel extends DefaultEditorPanel
{
	...
	public  ValidationSuiteControllerPanel() {
		super();
		editObj = new ValidationSuiteController();
		initUI();
		fillUiHashtable();
	}


	public  ValidationSuiteControllerPanel(ValidationSuiteController editObj) {
		super();
	...
	this.editObj = (ValidationSuiteController)editObj;
	initUI();
	}
	private void initUI() {
...
submodelGroups.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ValidationSuiteControllerPanel p = new ValidationSuiteControllerPanel();
