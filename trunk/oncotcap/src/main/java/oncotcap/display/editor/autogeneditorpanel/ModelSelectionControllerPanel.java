...
public class ModelSelectionControllerPanel extends DefaultEditorPanel
{
	...
	public  ModelSelectionControllerPanel() {
		super();
		editObj = new ModelSelectionController();
		initUI();
		fillUiHashtable();
	}


	public  ModelSelectionControllerPanel(ModelSelectionController editObj) {
		super();
	...
	this.editObj = (ModelSelectionController)editObj;
	initUI();
	}
	private void initUI() {
...
submodelGroups.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ModelSelectionControllerPanel p = new ModelSelectionControllerPanel();
