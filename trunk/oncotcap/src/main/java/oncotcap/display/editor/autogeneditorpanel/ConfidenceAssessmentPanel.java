...
public class ConfidenceAssessmentPanel extends DefaultEditorPanel
{
	...
	public  ConfidenceAssessmentPanel() {
		super();
		editObj = new ConfidenceAssessment();
		initUI();
		fillUiHashtable();
	}


	public  ConfidenceAssessmentPanel(ConfidenceAssessment editObj) {
		super();
	...
	this.editObj = (ConfidenceAssessment)editObj;
	initUI();
	}
	private void initUI() {
...
timeStamp.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ConfidenceAssessmentPanel p = new ConfidenceAssessmentPanel();
