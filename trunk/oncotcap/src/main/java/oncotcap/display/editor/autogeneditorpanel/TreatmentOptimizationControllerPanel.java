...
public class TreatmentOptimizationControllerPanel extends DefaultEditorPanel
{
	...
	public  TreatmentOptimizationControllerPanel() {
		super();
		editObj = new TreatmentOptimizationController();
		initUI();
		fillUiHashtable();
	}


	public  TreatmentOptimizationControllerPanel(TreatmentOptimizationController editObj) {
		super();
	...
	this.editObj = (TreatmentOptimizationController)editObj;
	initUI();
	}
	private void initUI() {
...
submodelGroups.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		TreatmentOptimizationControllerPanel p = new TreatmentOptimizationControllerPanel();
