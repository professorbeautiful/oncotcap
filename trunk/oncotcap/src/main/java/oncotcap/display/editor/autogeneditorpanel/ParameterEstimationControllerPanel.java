...
public class ParameterEstimationControllerPanel extends DefaultEditorPanel
{
	...
	public  ParameterEstimationControllerPanel() {
		super();
		editObj = new ParameterEstimationController();
		initUI();
		fillUiHashtable();
	}


	public  ParameterEstimationControllerPanel(ParameterEstimationController editObj) {
		super();
	...
	this.editObj = (ParameterEstimationController)editObj;
	initUI();
	}
	private void initUI() {
...
submodelGroups.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ParameterEstimationControllerPanel p = new ParameterEstimationControllerPanel();
