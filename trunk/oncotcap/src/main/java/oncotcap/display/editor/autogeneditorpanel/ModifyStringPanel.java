...
public class ModifyStringPanel extends DefaultEditorPanel
{
	...
	public  ModifyStringPanel() {
		super();
		editObj = new ModifyString();
		initUI();
		fillUiHashtable();
	}


	public  ModifyStringPanel(ModifyString editObj) {
		super();
	...
	this.editObj = (ModifyString)editObj;
	initUI();
	}
	private void initUI() {
...
creator.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ModifyStringPanel p = new ModifyStringPanel();
