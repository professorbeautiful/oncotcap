...
public class RelevanceAssessmentPanel extends DefaultEditorPanel
{
	...
	public  RelevanceAssessmentPanel() {
		super();
		editObj = new RelevanceAssessment();
		initUI();
		fillUiHashtable();
	}


	public  RelevanceAssessmentPanel(RelevanceAssessment editObj) {
		super();
	...
	this.editObj = (RelevanceAssessment)editObj;
	initUI();
	}
	private void initUI() {
...
timeStamp.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		RelevanceAssessmentPanel p = new RelevanceAssessmentPanel();
