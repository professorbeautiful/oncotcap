...
public class KnowledgeNuggetPanel extends DefaultEditorPanel
{
	...
	public  KnowledgeNuggetPanel() {
		super();
		editObj = new KnowledgeNugget();
		initUI();
		fillUiHashtable();
	}


	public  KnowledgeNuggetPanel(KnowledgeNugget editObj) {
		super();
	...
	this.editObj = (KnowledgeNugget)editObj;
	initUI();
	}
	private void initUI() {
...
keywords.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		KnowledgeNuggetPanel p = new KnowledgeNuggetPanel();
