...
public class ConditionalTableEventParameterPanel extends DefaultEditorPanel
{
	...
	public  ConditionalTableEventParameterPanel() {
		super();
		editObj = new ConditionalTableEventParameter();
		initUI();
		fillUiHashtable();
	}


	public  ConditionalTableEventParameterPanel(ConditionalTableEventParameter editObj) {
		super();
	...
	this.editObj = (ConditionalTableEventParameter)editObj;
	initUI();
	}
	private void initUI() {
...
function.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ConditionalTableEventParameterPanel p = new ConditionalTableEventParameterPanel();
