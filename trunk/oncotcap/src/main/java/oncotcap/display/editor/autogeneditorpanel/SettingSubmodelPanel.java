...
public class SettingSubmodelPanel extends DefaultEditorPanel
{
	...
	public  SettingSubmodelPanel() {
		super();
		editObj = new SettingSubmodel();
		initUI();
		fillUiHashtable();
	}


	public  SettingSubmodelPanel(SettingSubmodel editObj) {
		super();
	...
	this.editObj = (SettingSubmodel)editObj;
	initUI();
	}
	private void initUI() {
...
keywords.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		SettingSubmodelPanel p = new SettingSubmodelPanel();
