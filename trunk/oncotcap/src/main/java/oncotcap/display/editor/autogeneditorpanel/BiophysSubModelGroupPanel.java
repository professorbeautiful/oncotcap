...
public class BiophysSubModelGroupPanel extends DefaultEditorPanel
{
	...
	public  BiophysSubModelGroupPanel() {
		super();
		editObj = new BiophysSubModelGroup();
		initUI();
		fillUiHashtable();
	}


	public  BiophysSubModelGroupPanel(BiophysSubModelGroup editObj) {
		super();
	...
	this.editObj = (BiophysSubModelGroup)editObj;
	initUI();
	}
	private void initUI() {
...
submodelsInGroup.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		BiophysSubModelGroupPanel p = new BiophysSubModelGroupPanel();
