...
public class CellKineticsDemoControllerPanel extends DefaultEditorPanel
{
	...
	public  CellKineticsDemoControllerPanel() {
		super();
		editObj = new CellKineticsDemoController();
		initUI();
		fillUiHashtable();
	}


	public  CellKineticsDemoControllerPanel(CellKineticsDemoController editObj) {
		super();
	...
	this.editObj = (CellKineticsDemoController)editObj;
	initUI();
	}
	private void initUI() {
...
starterProcess.setBounds(0,710,250,60);
versionNumber.setBounds(0,650,125,60);
modelConfiguration.setBounds(0,590,250,60);
modelControllerName.setBounds(10,10,570,60);
outputScreens.setBounds(0,770,250,120);
introScreens.setBounds(370,80,250,120);
keywords.setBounds(10,330,250,120);
submodelGroups.setBounds(10,80,250,180);
...
submodelGroups.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		CellKineticsDemoControllerPanel p = new CellKineticsDemoControllerPanel();
