...
public class ReceptorPanel extends DefaultEditorPanel
{
	...
	public  ReceptorPanel() {
		super();
		editObj = new Receptor();
		initUI();
		fillUiHashtable();
	}


	public  ReceptorPanel(Receptor editObj) {
		super();
...
deactivates.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ReceptorPanel p = new ReceptorPanel();
