...
public class ContinuousAgentPanel extends DefaultEditorPanel
{
	...
	public  ContinuousAgentPanel() {
		super();
		editObj = new ContinuousAgent();
		initUI();
		fillUiHashtable();
	}


	public  ContinuousAgentPanel(ContinuousAgent editObj) {
		super();
	...
	this.editObj = (ContinuousAgent)editObj;
	initUI();
	}
	private void initUI() {
...
sentencesAboutThis.setVisible(true);
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		ContinuousAgentPanel p = new ContinuousAgentPanel();
